...
templates, instances, human-readable `position_xyz` model transforms, and
human-readable `vertices_xyz` / `faces` coordinate arrays. The builder validates
face indices, resolves that authoring form into compact numeric `.os3d` records,
