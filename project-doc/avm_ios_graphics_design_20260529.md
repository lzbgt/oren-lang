...
- `sdk/ios/OrenAVMKit` also exposes `OrenAVMGraphicsView`, a default
  ...
  `stroke_rect`/`round_rect`/`circle`/`ellipse`/`polyline`/`fill_triangle`/`fill_triangles`/`mesh2d`/`draw_mesh2d`/`destroy_mesh2d`/`mesh3d`/`draw_mesh3d`/`destroy_mesh3d`/`image_rgba`/
