...
Wavefront OBJ `obj_source` / `obj_text` and ASCII STL `stl_source` / `stl_text` mesh lowering, `triangles_xyz` or `quads_xyz` direct meshes, compact boxes/prisms and bounded
