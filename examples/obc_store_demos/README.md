...
Wavefront OBJ `obj_source` / `obj_text`, binary-or-ASCII STL `stl_source`, and inline ASCII STL `stl_text` mesh lowering, `triangles_xyz` or `quads_xyz` direct meshes, compact boxes/prisms and bounded
