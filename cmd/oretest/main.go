...
func main() {
	...
	fixtures := []struct {
		...
		{
			name: "native_x64_malloc_ptr_builds",
			cmd: fmt.Sprintf(
				"./oren build %q --backend native --target linux --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q && "+
					"./oren build %q --backend native --target windows --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q",
				"tests/fixtures/x64_malloc_ptr_main.oren",
				"build/x64_malloc_ptr_linux",
				"build/x64_malloc_ptr_linux.build.out",
				"build/x64_malloc_ptr_linux",
				"build/x64_malloc_ptr_linux.file.out",
				"ELF 64-bit",
				"build/x64_malloc_ptr_linux.file.out",
				"x86-64",
				"build/x64_malloc_ptr_linux.file.out",
				"tests/fixtures/x64_malloc_ptr_main.oren",
				"build/x64_malloc_ptr_win.exe",
				"build/x64_malloc_ptr_win.build.out",
				"build/x64_malloc_ptr_win.exe",
				"build/x64_malloc_ptr_win.file.out",
				"PE32+",
				"build/x64_malloc_ptr_win.file.out",
				"x86-64",
				"build/x64_malloc_ptr_win.file.out",
			),
			log: "build/logs/native_x64_malloc_ptr_builds.log",
			ok:  func(rc int) bool { return rc == 0 },
			cleanup: []string{
				"build/x64_malloc_ptr_linux",
				"build/x64_malloc_ptr_linux.build.out",
		...
		{
			name: "native_x64_list_ops_builds",
			cmd: fmt.Sprintf(
				"./oren build %q --backend native --target linux --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q && "+
					"./oren build %q --backend native --target windows --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q",
				"tests/fixtures/x64_list_ops_main.oren",
				"build/x64_list_ops_linux",
				"build/x64_list_ops_linux.build.out",
				"build/x64_list_ops_linux",
				"build/x64_list_ops_linux.file.out",
				"ELF 64-bit",
				"build/x64_list_ops_linux.file.out",
				"x86-64",
				"build/x64_list_ops_linux.file.out",
				"tests/fixtures/x64_list_ops_main.oren",
				"build/x64_list_ops_win.exe",
				"build/x64_list_ops_win.build.out",
				"build/x64_list_ops_win.exe",
				"build/x64_list_ops_win.file.out",
				"PE32+",
				"build/x64_list_ops_win.file.out",
				"x86-64",
				"build/x64_list_ops_win.file.out",
			),
			log: "build/logs/native_x64_list_ops_builds.log",
			ok:  func(rc int) bool { return rc == 0 },
			cleanup: []string{
				"build/x64_list_ops_linux",
				"build/x64_list_ops_linux.build.out",
		...
		},
		{
			...
			cmd: fmt.Sprintf(
				"./oren build %q --backend native --target linux --arch x64 -o %q > %q && "+
					...
					"./oren build %q --backend native --target windows --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q",
				"tests/fixtures/x64_list_method_sugar_main.oren",
				"build/x64_list_method_sugar_linux",
				"build/x64_list_method_sugar_linux.build.out",
				"build/x64_list_method_sugar_linux",
				"build/x64_list_method_sugar_linux.file.out",
				"ELF 64-bit",
				"build/x64_list_method_sugar_linux.file.out",
				"x86-64",
				"build/x64_list_method_sugar_linux.file.out",
				"tests/fixtures/x64_list_method_sugar_main.oren",
				"build/x64_list_method_sugar_win.exe",
				"build/x64_list_method_sugar_win.build.out",
				"build/x64_list_method_sugar_win.exe",
				"build/x64_list_method_sugar_win.file.out",
				"PE32+",
				"build/x64_list_method_sugar_win.file.out",
				"x86-64",
				"build/x64_list_method_sugar_win.file.out",
			),
			log: "build/logs/native_x64_list_method_sugar_builds.log",
			ok:  func(rc int) bool { return rc == 0 },
			cleanup: []string{
				"build/x64_list_method_sugar_linux",
				"build/x64_list_method_sugar_linux.build.out",
		...
		{
			name: "native_x64_std_list_namespace_builds",
			cmd: fmt.Sprintf(
				"./oren build %q --backend native --target linux --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q && "+
					"./oren build %q --backend native --target windows --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q",
				"tests/fixtures/x64_std_list_namespace_main.oren",
				"build/x64_std_list_namespace_linux",
				"build/x64_std_list_namespace_linux.build.out",
				"build/x64_std_list_namespace_linux",
				"build/x64_std_list_namespace_linux.file.out",
				"ELF 64-bit",
				"build/x64_std_list_namespace_linux.file.out",
				"x86-64",
				"build/x64_std_list_namespace_linux.file.out",
				"tests/fixtures/x64_std_list_namespace_main.oren",
				"build/x64_std_list_namespace_win.exe",
				"build/x64_std_list_namespace_win.build.out",
				"build/x64_std_list_namespace_win.exe",
				"build/x64_std_list_namespace_win.file.out",
				"PE32+",
				"build/x64_std_list_namespace_win.file.out",
				"x86-64",
				"build/x64_std_list_namespace_win.file.out",
			),
			log: "build/logs/native_x64_std_list_namespace_builds.log",
			ok:  func(rc int) bool { return rc == 0 },
			cleanup: []string{
				"build/x64_std_list_namespace_linux",
				"build/x64_std_list_namespace_linux.build.out",
		...
		{
			name: "native_x64_string_literal_bytes_builds",
			cmd: fmt.Sprintf(
				"./oren build %q --backend native --target linux --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q && "+
					"./oren build %q --backend native --target windows --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q",
				"tests/fixtures/x64_string_literal_bytes_main.oren",
				"build/x64_string_literal_bytes_linux",
				"build/x64_string_literal_bytes_linux.build.out",
				"build/x64_string_literal_bytes_linux",
				"build/x64_string_literal_bytes_linux.file.out",
				"ELF 64-bit",
				"build/x64_string_literal_bytes_linux.file.out",
				"x86-64",
				"build/x64_string_literal_bytes_linux.file.out",
				"tests/fixtures/x64_string_literal_bytes_main.oren",
				"build/x64_string_literal_bytes_win.exe",
				"build/x64_string_literal_bytes_win.build.out",
				"build/x64_string_literal_bytes_win.exe",
				"build/x64_string_literal_bytes_win.file.out",
				"PE32+",
				"build/x64_string_literal_bytes_win.file.out",
				"x86-64",
				"build/x64_string_literal_bytes_win.file.out",
			),
			log: "build/logs/native_x64_string_literal_bytes_builds.log",
			ok:  func(rc int) bool { return rc == 0 },
			cleanup: []string{
				"build/x64_string_literal_bytes_linux",
				"build/x64_string_literal_bytes_linux.build.out",
		...
		{
			name: "native_x64_map_literal_builds",
			cmd: fmt.Sprintf(
				"./oren build %q --backend native --target linux --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q && "+
					"./oren build %q --backend native --target windows --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q",
				"tests/fixtures/x64_map_literal_main.oren",
				"build/x64_map_literal_linux",
				"build/x64_map_literal_linux.build.out",
				"build/x64_map_literal_linux",
				"build/x64_map_literal_linux.file.out",
				"ELF 64-bit",
				"build/x64_map_literal_linux.file.out",
				"x86-64",
				"build/x64_map_literal_linux.file.out",
				"tests/fixtures/x64_map_literal_main.oren",
				"build/x64_map_literal_win.exe",
				"build/x64_map_literal_win.build.out",
				"build/x64_map_literal_win.exe",
				"build/x64_map_literal_win.file.out",
				"PE32+",
				"build/x64_map_literal_win.file.out",
				"x86-64",
				"build/x64_map_literal_win.file.out",
			),
			log: "build/logs/native_x64_map_literal_builds.log",
			ok:  func(rc int) bool { return rc == 0 },
			cleanup: []string{
				"build/x64_map_literal_linux",
				"build/x64_map_literal_linux.build.out",
		...
		{
			name: "native_x64_nested_map_literal_builds",
			cmd: fmt.Sprintf(
				"./oren build %q --backend native --target linux --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q && "+
					"./oren build %q --backend native --target windows --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q",
				"tests/fixtures/x64_nested_map_literal_main.oren",
				"build/x64_nested_map_literal_linux",
				"build/x64_nested_map_literal_linux.build.out",
				"build/x64_nested_map_literal_linux",
				"build/x64_nested_map_literal_linux.file.out",
				"ELF 64-bit",
				"build/x64_nested_map_literal_linux.file.out",
				"x86-64",
				"build/x64_nested_map_literal_linux.file.out",
				"tests/fixtures/x64_nested_map_literal_main.oren",
				"build/x64_nested_map_literal_win.exe",
				"build/x64_nested_map_literal_win.build.out",
				"build/x64_nested_map_literal_win.exe",
				"build/x64_nested_map_literal_win.file.out",
				"PE32+",
				"build/x64_nested_map_literal_win.file.out",
				"x86-64",
				"build/x64_nested_map_literal_win.file.out",
			),
			log: "build/logs/native_x64_nested_map_literal_builds.log",
			ok:  func(rc int) bool { return rc == 0 },
			cleanup: []string{
				"build/x64_nested_map_literal_linux",
				"build/x64_nested_map_literal_linux.build.out",
		...
		{
			name: "native_x64_intr_reentrancy_builds",
			cmd: fmt.Sprintf(
				"./oren build %q --backend native --target linux --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q && "+
					"./oren build %q --backend native --target windows --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q",
				"tests/fixtures/x64_intr_reentrancy_main.oren",
				"build/x64_intr_reentrancy_linux",
				"build/x64_intr_reentrancy_linux.build.out",
				"build/x64_intr_reentrancy_linux",
				"build/x64_intr_reentrancy_linux.file.out",
				"ELF 64-bit",
				"build/x64_intr_reentrancy_linux.file.out",
				"x86-64",
				"build/x64_intr_reentrancy_linux.file.out",
				"tests/fixtures/x64_intr_reentrancy_main.oren",
				"build/x64_intr_reentrancy_win.exe",
				"build/x64_intr_reentrancy_win.build.out",
				"build/x64_intr_reentrancy_win.exe",
				"build/x64_intr_reentrancy_win.file.out",
				"PE32+",
				"build/x64_intr_reentrancy_win.file.out",
				"x86-64",
				"build/x64_intr_reentrancy_win.file.out",
			),
			log: "build/logs/native_x64_intr_reentrancy_builds.log",
			ok:  func(rc int) bool { return rc == 0 },
			cleanup: []string{
				"build/x64_intr_reentrancy_linux",
				"build/x64_intr_reentrancy_linux.build.out",
		...
		{
			name: "native_x64_nested_call_args_builds",
			cmd: fmt.Sprintf(
				"./oren build %q --backend native --target linux --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q && "+
					"./oren build %q --backend native --target windows --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q",
				"tests/fixtures/x64_nested_call_args_main.oren",
				"build/x64_nested_call_args_linux",
				"build/x64_nested_call_args_linux.build.out",
				"build/x64_nested_call_args_linux",
				"build/x64_nested_call_args_linux.file.out",
				"ELF 64-bit",
				"build/x64_nested_call_args_linux.file.out",
				"x86-64",
				"build/x64_nested_call_args_linux.file.out",
				"tests/fixtures/x64_nested_call_args_main.oren",
				"build/x64_nested_call_args_win.exe",
				"build/x64_nested_call_args_win.build.out",
				"build/x64_nested_call_args_win.exe",
				"build/x64_nested_call_args_win.file.out",
				"PE32+",
				"build/x64_nested_call_args_win.file.out",
				"x86-64",
				"build/x64_nested_call_args_win.file.out",
			),
			log: "build/logs/native_x64_nested_call_args_builds.log",
			ok:  func(rc int) bool { return rc == 0 },
			cleanup: []string{
				"build/x64_nested_call_args_linux",
				"build/x64_nested_call_args_linux.build.out",
		...
		{
			name: "native_x64_map_index_get_builds",
			cmd: fmt.Sprintf(
				"./oren build %q --backend native --target linux --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q && "+
					"./oren build %q --backend native --target windows --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q",
				"tests/fixtures/x64_map_index_get_main.oren",
				"build/x64_map_index_get_linux",
				"build/x64_map_index_get_linux.build.out",
				"build/x64_map_index_get_linux",
				"build/x64_map_index_get_linux.file.out",
				"ELF 64-bit",
				"build/x64_map_index_get_linux.file.out",
				"x86-64",
				"build/x64_map_index_get_linux.file.out",
				"tests/fixtures/x64_map_index_get_main.oren",
				"build/x64_map_index_get_win.exe",
				"build/x64_map_index_get_win.build.out",
				"build/x64_map_index_get_win.exe",
				"build/x64_map_index_get_win.file.out",
				"PE32+",
				"build/x64_map_index_get_win.file.out",
				"x86-64",
				"build/x64_map_index_get_win.file.out",
			),
			log: "build/logs/native_x64_map_index_get_builds.log",
			ok:  func(rc int) bool { return rc == 0 },
			cleanup: []string{
				"build/x64_map_index_get_linux",
				"build/x64_map_index_get_linux.build.out",
		...
		{
			name: "native_x64_map_index_set_builds",
			cmd: fmt.Sprintf(
				"./oren build %q --backend native --target linux --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q && "+
					"./oren build %q --backend native --target windows --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q",
				"tests/fixtures/x64_map_index_set_main.oren",
				"build/x64_map_index_set_linux",
				"build/x64_map_index_set_linux.build.out",
				"build/x64_map_index_set_linux",
				"build/x64_map_index_set_linux.file.out",
				"ELF 64-bit",
				"build/x64_map_index_set_linux.file.out",
				"x86-64",
				"build/x64_map_index_set_linux.file.out",
				"tests/fixtures/x64_map_index_set_main.oren",
				"build/x64_map_index_set_win.exe",
				"build/x64_map_index_set_win.build.out",
				"build/x64_map_index_set_win.exe",
				"build/x64_map_index_set_win.file.out",
				"PE32+",
				"build/x64_map_index_set_win.file.out",
				"x86-64",
				"build/x64_map_index_set_win.file.out",
			),
			log: "build/logs/native_x64_map_index_set_builds.log",
			ok:  func(rc int) bool { return rc == 0 },
			cleanup: []string{
				"build/x64_map_index_set_linux",
				"build/x64_map_index_set_linux.build.out",
		...
		{
			name: "native_x64_map_int_key_builds",
			cmd: fmt.Sprintf(
				"./oren build %q --backend native --target linux --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q && "+
					"./oren build %q --backend native --target windows --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q",
				"tests/fixtures/x64_map_int_key_main.oren",
				"build/x64_map_int_key_linux",
				"build/x64_map_int_key_linux.build.out",
				"build/x64_map_int_key_linux",
				"build/x64_map_int_key_linux.file.out",
				"ELF 64-bit",
				"build/x64_map_int_key_linux.file.out",
				"x86-64",
				"build/x64_map_int_key_linux.file.out",
				"tests/fixtures/x64_map_int_key_main.oren",
				"build/x64_map_int_key_win.exe",
				"build/x64_map_int_key_win.build.out",
				"build/x64_map_int_key_win.exe",
				"build/x64_map_int_key_win.file.out",
				"PE32+",
				"build/x64_map_int_key_win.file.out",
				"x86-64",
				"build/x64_map_int_key_win.file.out",
			),
			log: "build/logs/native_x64_map_int_key_builds.log",
			ok:  func(rc int) bool { return rc == 0 },
			cleanup: []string{
				"build/x64_map_int_key_linux",
				"build/x64_map_int_key_linux.build.out",
		...
		{
			name: "native_x64_spread_fixed_arity_builds",
			cmd: fmt.Sprintf(
				"./oren build %q --backend native --target linux --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q && "+
					"./oren build %q --backend native --target windows --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q",
				"tests/fixtures/x64_spread_fixed_arity_main.oren",
				"build/x64_spread_fixed_arity_linux",
				"build/x64_spread_fixed_arity_linux.build.out",
				"build/x64_spread_fixed_arity_linux",
				"build/x64_spread_fixed_arity_linux.file.out",
				"ELF 64-bit",
				"build/x64_spread_fixed_arity_linux.file.out",
				"x86-64",
				"build/x64_spread_fixed_arity_linux.file.out",
				"tests/fixtures/x64_spread_fixed_arity_main.oren",
				"build/x64_spread_fixed_arity_win.exe",
				"build/x64_spread_fixed_arity_win.build.out",
				"build/x64_spread_fixed_arity_win.exe",
				"build/x64_spread_fixed_arity_win.file.out",
				"PE32+",
				"build/x64_spread_fixed_arity_win.file.out",
				"x86-64",
				"build/x64_spread_fixed_arity_win.file.out",
			),
			log: "build/logs/native_x64_spread_fixed_arity_builds.log",
			ok:  func(rc int) bool { return rc == 0 },
			cleanup: []string{
				"build/x64_spread_fixed_arity_linux",
				"build/x64_spread_fixed_arity_linux.build.out",
		...
		{
			name: "native_x64_spread_len_mismatch_builds",
			cmd: fmt.Sprintf(
				"./oren build %q --backend native --target linux --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q && "+
					"./oren build %q --backend native --target windows --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q",
				"tests/fixtures/x64_spread_len_mismatch_main.oren",
				"build/x64_spread_len_mismatch_linux",
				"build/x64_spread_len_mismatch_linux.build.out",
				"build/x64_spread_len_mismatch_linux",
				"build/x64_spread_len_mismatch_linux.file.out",
				"ELF 64-bit",
				"build/x64_spread_len_mismatch_linux.file.out",
				"x86-64",
				"build/x64_spread_len_mismatch_linux.file.out",
				"tests/fixtures/x64_spread_len_mismatch_main.oren",
				"build/x64_spread_len_mismatch_win.exe",
				"build/x64_spread_len_mismatch_win.build.out",
				"build/x64_spread_len_mismatch_win.exe",
				"build/x64_spread_len_mismatch_win.file.out",
				"PE32+",
				"build/x64_spread_len_mismatch_win.file.out",
				"x86-64",
				"build/x64_spread_len_mismatch_win.file.out",
			),
			log: "build/logs/native_x64_spread_len_mismatch_builds.log",
			ok:  func(rc int) bool { return rc == 0 },
			cleanup: []string{
				"build/x64_spread_len_mismatch_linux",
				"build/x64_spread_len_mismatch_linux.build.out",
		...
		{
			name: "native_x64_varargs_spread_builds",
			cmd: fmt.Sprintf(
				"./oren build %q --backend native --target linux --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q && "+
					"./oren build %q --backend native --target windows --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q",
				"tests/fixtures/x64_varargs_spread_main.oren",
				"build/x64_varargs_spread_linux",
				"build/x64_varargs_spread_linux.build.out",
				"build/x64_varargs_spread_linux",
				"build/x64_varargs_spread_linux.file.out",
				"ELF 64-bit",
				"build/x64_varargs_spread_linux.file.out",
				"x86-64",
				"build/x64_varargs_spread_linux.file.out",
				"tests/fixtures/x64_varargs_spread_main.oren",
				"build/x64_varargs_spread_win.exe",
				"build/x64_varargs_spread_win.build.out",
				"build/x64_varargs_spread_win.exe",
				"build/x64_varargs_spread_win.file.out",
				"PE32+",
				"build/x64_varargs_spread_win.file.out",
				"x86-64",
				"build/x64_varargs_spread_win.file.out",
			),
			log: "build/logs/native_x64_varargs_spread_builds.log",
			ok:  func(rc int) bool { return rc == 0 },
			cleanup: []string{
				"build/x64_varargs_spread_linux",
				"build/x64_varargs_spread_linux.build.out",
		...
		{
			name: "native_x64_varargs_spread_fill_fixed_builds",
			cmd: fmt.Sprintf(
				"./oren build %q --backend native --target linux --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q && "+
					"./oren build %q --backend native --target windows --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q",
				"tests/fixtures/x64_varargs_spread_fill_fixed_main.oren",
				"build/x64_varargs_spread_fill_fixed_linux",
				"build/x64_varargs_spread_fill_fixed_linux.build.out",
				"build/x64_varargs_spread_fill_fixed_linux",
				"build/x64_varargs_spread_fill_fixed_linux.file.out",
				"ELF 64-bit",
				"build/x64_varargs_spread_fill_fixed_linux.file.out",
				"x86-64",
				"build/x64_varargs_spread_fill_fixed_linux.file.out",
				"tests/fixtures/x64_varargs_spread_fill_fixed_main.oren",
				"build/x64_varargs_spread_fill_fixed_win.exe",
				"build/x64_varargs_spread_fill_fixed_win.build.out",
				"build/x64_varargs_spread_fill_fixed_win.exe",
				"build/x64_varargs_spread_fill_fixed_win.file.out",
				"PE32+",
				"build/x64_varargs_spread_fill_fixed_win.file.out",
				"x86-64",
				"build/x64_varargs_spread_fill_fixed_win.file.out",
			),
			log: "build/logs/native_x64_varargs_spread_fill_fixed_builds.log",
			ok:  func(rc int) bool { return rc == 0 },
			cleanup: []string{
				"build/x64_varargs_spread_fill_fixed_linux",
				"build/x64_varargs_spread_fill_fixed_linux.build.out",
		...
		{
			name: "native_x64_varargs_spread_too_short_builds",
			cmd: fmt.Sprintf(
				"./oren build %q --backend native --target linux --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q && "+
					"./oren build %q --backend native --target windows --arch x64 -o %q > %q && "+
					"file %q > %q && grep -Fq %q %q && grep -Fq %q %q",
				"tests/fixtures/x64_varargs_spread_too_short_main.oren",
				"build/x64_varargs_spread_too_short_linux",
				"build/x64_varargs_spread_too_short_linux.build.out",
				"build/x64_varargs_spread_too_short_linux",
				"build/x64_varargs_spread_too_short_linux.file.out",
				"ELF 64-bit",
				"build/x64_varargs_spread_too_short_linux.file.out",
				"x86-64",
				"build/x64_varargs_spread_too_short_linux.file.out",
				"tests/fixtures/x64_varargs_spread_too_short_main.oren",
				"build/x64_varargs_spread_too_short_win.exe",
				"build/x64_varargs_spread_too_short_win.build.out",
				"build/x64_varargs_spread_too_short_win.exe",
				"build/x64_varargs_spread_too_short_win.file.out",
				"PE32+",
				"build/x64_varargs_spread_too_short_win.file.out",
				"x86-64",
				"build/x64_varargs_spread_too_short_win.file.out",
			),
			log: "build/logs/native_x64_varargs_spread_too_short_builds.log",
			ok:  func(rc int) bool { return rc == 0 },
			cleanup: []string{
				"build/x64_varargs_spread_too_short_linux",
				"build/x64_varargs_spread_too_short_linux.build.out",
	...
	if envBool("OREN_REMOTE_RUN", false) {
		...
		remoteX64 := []struct {
			...
			{name: "remote_x64_run_map_literal_exitcode", src: "tests/fixtures/x64_map_literal_main.oren", expectExit: 0, timeout: 5 * time.Minute},
			{name: "remote_x64_run_nested_map_literal_exitcode", src: "tests/fixtures/x64_nested_map_literal_main.oren", expectExit: 0, timeout: 5 * time.Minute},
			{name: "remote_x64_run_intr_reentrancy_exitcode", src: "tests/fixtures/x64_intr_reentrancy_main.oren", expectExit: 0, timeout: 5 * time.Minute},
			...
			{name: "remote_x64_run_and_or_short_circuit_exitcode", src: "tests/fixtures/x64_and_or_short_circuit_main.oren", expectExit: 5, timeout: 5 * time.Minute},
			{name: "remote_x64_run_call_exitcode", src: "tests/fixtures/x64_call_main.oren", expectExit: 15, timeout: 5 * time.Minute},
			{name: "remote_x64_run_call_args2_exitcode", src: "tests/fixtures/x64_call_args2_main.oren", expectExit: 5, timeout: 5 * time.Minute},
			...
			{name: "remote_x64_run_spread_fixed_arity_exitcode", src: "tests/fixtures/x64_spread_fixed_arity_main.oren", expectExit: 0, timeout: 5 * time.Minute},
			{name: "remote_x64_run_spread_len_mismatch_exitcode", src: "tests/fixtures/x64_spread_len_mismatch_main.oren", expectExit: 1, timeout: 5 * time.Minute},
			{name: "remote_x64_run_varargs_spread_exitcode", src: "tests/fixtures/x64_varargs_spread_main.oren", expectExit: 0, timeout: 5 * time.Minute},
			{name: "remote_x64_run_varargs_spread_fill_fixed_exitcode", src: "tests/fixtures/x64_varargs_spread_fill_fixed_main.oren", expectExit: 0, timeout: 5 * time.Minute},
			{name: "remote_x64_run_varargs_spread_too_short_exitcode", src: "tests/fixtures/x64_varargs_spread_too_short_main.oren", expectExit: 1, timeout: 5 * time.Minute},
			...
			{name: "remote_x64_run_break_continue_exitcode", src: "tests/fixtures/x64_break_continue_main.oren", expectExit: 3, timeout: 5 * time.Minute},
			{name: "remote_x64_run_for_exitcode", src: "tests/fixtures/x64_for_main.oren", expectExit: 4, timeout: 5 * time.Minute},
			{name: "remote_x64_run_mul_exitcode", src: "tests/fixtures/x64_mul_expr_main.oren", expectExit: 42, timeout: 5 * time.Minute},
			{name: "remote_x64_run_cmp_exitcode", src: "tests/fixtures/x64_cmp_main.oren", expectExit: 5, timeout: 5 * time.Minute},
			{name: "remote_x64_run_cmp_expr_value_exitcode", src: "tests/fixtures/x64_cmp_expr_value_main.oren", expectExit: 21, timeout: 5 * time.Minute},
			{name: "remote_x64_run_not_expr_value_exitcode", src: "tests/fixtures/x64_not_expr_value_main.oren", expectExit: 11, timeout: 5 * time.Minute},
			{name: "remote_x64_run_cmp_neg_exitcode", src: "tests/fixtures/x64_cmp_neg_main.oren", expectExit: 35, timeout: 5 * time.Minute},
			{name: "remote_x64_run_prefix_exitcode", src: "tests/fixtures/x64_prefix_main.oren", expectExit: 1, timeout: 5 * time.Minute},
			{name: "remote_x64_run_else_if_exitcode", src: "tests/fixtures/x64_else_if_main.oren", expectExit: 20, timeout: 5 * time.Minute},
			{name: "remote_x64_run_while_lt_exitcode", src: "tests/fixtures/x64_while_lt_main.oren", expectExit: 3, timeout: 5 * time.Minute},
		}
