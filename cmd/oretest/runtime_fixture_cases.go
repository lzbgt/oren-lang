	...
	runtimeFixtures := []runtimeFixtureCase{
		{
			...
			build: fmt.Sprintf("./oren build %q --backend native --platform %s -o %q%s", "tests/native/fixtures/system_shell_missing.oren", plat, targetsOutPath(target, arch, "native", "system_shell_missing_native"), gcArg),
		...
		},
		{
			...
			build: fmt.Sprintf("./oren build %q --backend native --platform %s -o %q%s", "tests/native/fixtures/diag_fail.oren", plat, targetsOutPath(target, arch, "native", "diag_fail_native"), gcArg),
		...
		{
			name:  "diag_fail_c",
			build: fmt.Sprintf("./oren build %q --backend c --platform %s -o %q%s", "tests/native/fixtures/diag_fail.oren", plat, targetsOutPath(target, arch, "c", "diag_fail_c"), gcArg),
		...
		},
		{
			...
			build: fmt.Sprintf("./oren build %q --backend native --platform %s -o %q%s", "tests/native/fixtures/arith_div0.oren", plat, targetsOutPath(target, arch, "native", "arith_div0_native"), gcArg),
		...
		{
			name:  "arith_div0_c",
			build: fmt.Sprintf("./oren build %q --backend c --platform %s -o %q%s", "tests/native/fixtures/arith_div0.oren", plat, targetsOutPath(target, arch, "c", "arith_div0_c"), gcArg),
		...
		},
		{
			...
			build: fmt.Sprintf("./oren build %q --backend native --platform %s -o %q%s", "tests/native/fixtures/arith_div_overflow.oren", plat, targetsOutPath(target, arch, "native", "arith_div_overflow_native"), gcArg),
		...
		},
		{
			...
			build: fmt.Sprintf("./oren build %q --backend c --platform %s -o %q%s", "tests/native/fixtures/arith_div_overflow.oren", plat, targetsOutPath(target, arch, "c", "arith_div_overflow_c"), gcArg),
		...
		},
		{
			...
			build: fmt.Sprintf("./oren build %q --backend native --platform %s -o %q%s", "tests/native/fixtures/arith_shift_oob.oren", plat, targetsOutPath(target, arch, "native", "arith_shift_oob_native"), gcArg),
		...
		},
		{
			...
			build: fmt.Sprintf("./oren build %q --backend c --platform %s -o %q%s", "tests/native/fixtures/arith_shift_oob.oren", plat, targetsOutPath(target, arch, "c", "arith_shift_oob_c"), gcArg),
		...
		},
		{
			...
			build: fmt.Sprintf("./oren build %q --backend c --platform %s -o %q%s", "tests/native/fixtures/call_depth_overflow.oren", plat, targetsOutPath(target, arch, "c", "call_depth_overflow_c"), gcArg),
		...
		},
		{
			...
			build: fmt.Sprintf("./oren build %q --backend native --platform %s -o %q%s", "tests/native/fixtures/call_depth_overflow.oren", plat, targetsOutPath(target, arch, "native", "call_depth_overflow_native"), gcArg),
		...
		},
		{
			...
			build: fmt.Sprintf("./oren build %q --backend c --platform %s -o %q%s", "tests/native/fixtures/tail_recursion_ok.oren", plat, targetsOutPath(target, arch, "c", "tail_recursion_ok_c"), gcArg),
		...
		},
		{
			...
			build: fmt.Sprintf("./oren build %q --backend native --platform %s -o %q%s", "tests/native/fixtures/tail_recursion_ok.oren", plat, targetsOutPath(target, arch, "native", "tail_recursion_ok_native"), gcArg),
		...
		},
		{
			...
			build: fmt.Sprintf("./oren build %q --backend c --platform %s -o %q%s", "tests/native/fixtures/non_tail_modconst_ok.oren", plat, targetsOutPath(target, arch, "c", "non_tail_modconst_ok_c"), gcArg),
		...
		},
		{
			...
			build: fmt.Sprintf("./oren build %q --backend native --platform %s -o %q%s", "tests/native/fixtures/non_tail_modconst_ok.oren", plat, targetsOutPath(target, arch, "native", "non_tail_modconst_ok_native"), gcArg),
