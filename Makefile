...
.PHONY: verify-native-ir-toolchain verify-native-ir-validator verify-native-ir-dump verify-native-ir-parity verify-native-ir-llvm-object verify-native-ir-llvm-lowering verify-native-ir-llvm-backend verify-native-ir-llvm-runtime verify-native-ir-llvm-helper-runtime verify-native-ir-llvm-exit-runtime verify-native-ir-llvm-smoke verify-native-ir-llvm-workflow
