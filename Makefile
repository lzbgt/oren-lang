...
.PHONY: verify-yield-lowering-v0 verify-yield-backend-parity-v0 verify-yield-value-surface-v0 verify-yield-exchange-surface-v0 verify-generator-surface-v0 probe-generator-nested-green-resume-block-v0
...
probe-generator-nested-green-resume-block-v0: oren_stage2
	@./scripts/probe_generator_nested_green_resume_block_v0.sh "./$(OREN_STAGE2_BIN)"
