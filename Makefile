...
# Focused runtime guard (stage1): isolate the green-cache local-ptr stress slice with
# strict no-retry semantics so the intermittent args-list corruption path has a stable entrypoint.
