...
.PHONY: verify-native-x64-compile verify-x64-call-depth-fixups
.PHONY: verify-native-ir-toolchain verify-native-ir-validator verify-native-ir-dump verify-native-ir-parity verify-native-ir-llvm-object verify-native-ir-llvm-lowering verify-native-ir-llvm-backend verify-native-ir-llvm-runtime verify-native-ir-llvm-helper-runtime verify-native-ir-llvm-exit-runtime verify-native-ir-llvm-string-runtime verify-native-ir-llvm-string-eq-runtime verify-native-ir-llvm-string-slice-runtime verify-native-ir-llvm-string-access-runtime verify-native-ir-llvm-list-runtime verify-native-ir-llvm-bytes-runtime verify-native-ir-llvm-map-runtime verify-native-ir-llvm-smoke verify-native-ir-llvm-workflow
...
.PHONY: astbin-seed verify-astbin-malformed-decode
...
verify-astbin-malformed-decode: oren
	@./scripts/verify_astbin_malformed_decode.sh
...
verify-docs-site:
	@python3 -m py_compile scripts/build_docs_site.py
	@python3 -m py_compile scripts/verify_docs_site.py
	@./scripts/build_docs_site.py
...
verify-obc-store-deploy-script:
	...
	@./scripts/deploy_obc_store_service.sh --help | grep -q 'OBC_STORE_ADMIN_HOST'
	@./scripts/deploy_obc_store_service.sh --help | grep -q 'OBC_STORE_SSH_PASSWORD'
	@./scripts/deploy_obc_store_service.sh --help | grep -q 'OBC_STORE_BUILD_COMMIT'
...
verify-obc-store-live-route:
	@bash -n scripts/verify_obc_store_live_route.sh
	@./scripts/verify_obc_store_live_route.sh
...
verify-native-ir-toolchain:
	@./scripts/verify_native_ir_toolchain.sh

verify-native-ir-validator: oren_stage2 avm
	@./scripts/verify_native_ir_validator.sh "./$(OREN_STAGE2_BIN)"

verify-native-ir-dump: oren_stage2
	@./scripts/verify_native_ir_dump.sh "./$(OREN_STAGE2_BIN)"

verify-native-ir-parity: oren_stage2
	@./scripts/verify_native_ir_parity.sh "./$(OREN_STAGE2_BIN)"

verify-native-ir-llvm-object: oren_stage2
	@./scripts/verify_native_ir_llvm_object.sh "./$(OREN_STAGE2_BIN)"

verify-native-ir-llvm-lowering: oren_stage2
	@./scripts/verify_native_ir_llvm_lowering.sh "./$(OREN_STAGE2_BIN)"

verify-native-ir-llvm-backend: oren_stage2
	@./scripts/verify_native_ir_llvm_backend.sh "./$(OREN_STAGE2_BIN)"

verify-native-ir-llvm-runtime: oren_stage2
	@./scripts/verify_native_ir_llvm_runtime.sh "./$(OREN_STAGE2_BIN)"

verify-native-ir-llvm-helper-runtime: oren_stage2
	@./scripts/verify_native_ir_llvm_helper_runtime.sh "./$(OREN_STAGE2_BIN)"

verify-native-ir-llvm-exit-runtime: oren_stage2
	@./scripts/verify_native_ir_llvm_exit_runtime.sh "./$(OREN_STAGE2_BIN)"

verify-native-ir-llvm-string-runtime: oren_stage2
	@./scripts/verify_native_ir_llvm_string_runtime.sh "./$(OREN_STAGE2_BIN)"

verify-native-ir-llvm-string-eq-runtime: oren_stage2
	@./scripts/verify_native_ir_llvm_string_eq_runtime.sh "./$(OREN_STAGE2_BIN)"

verify-native-ir-llvm-string-slice-runtime: oren_stage2
...
verify-native-ir-llvm-bytes-runtime: oren_stage2
	@./scripts/verify_native_ir_llvm_bytes_runtime.sh "./$(OREN_STAGE2_BIN)"

verify-native-ir-llvm-map-runtime: oren_stage2
	@./scripts/verify_native_ir_llvm_map_runtime.sh "./$(OREN_STAGE2_BIN)"
...
verify-native-x64-compile: oren_stage2 rtobj-seed-x64 astbin-seed-x64
			@./scripts/verify_x64_call_depth_fixups.sh
			@./scripts/verify_native_x64_compile_only.sh

verify-x64-call-depth-fixups:
			@./scripts/verify_x64_call_depth_fixups.sh

# Higher-signal compile-only gate: compile the compiler program for x64 targets and validate artifact kinds.
# - Default source: `oren.oren`; compiler imports are pruned by `@cfg(arch=...)`
#   so x64 compiler artifacts still use lightweight arm64 backend stubs.
#
