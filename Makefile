...
perf-probe-arm64-fast-dot-cursor-end-bounds: oren_stage2
	@./scripts/run_perf_probe_arm64_fast_dot_cursor_end_bounds.sh

perf-probe-arm64-fast-dot-cursor-end-snippet: oren_stage2
	@./scripts/run_perf_probe_arm64_fast_dot_cursor_end_snippet.sh

perf-probe-arm64-fast-dot-cursor-end-read-split: oren_stage2
	@./scripts/run_perf_probe_arm64_fast_dot_cursor_end_read_split.sh
