...
For the next-gen plan and design direction, see `docs/AVM_ROADMAP.md`.
For OBC portability/linking and signing, see `docs/OBC_DISTRIBUTION.md`.
...
- `docs/AVM_ROADMAP.md` (Next-Gen AVM Plan)
