...
- Native syscall lowering: added Oren-level `O_NONBLOCK` and translated fcntl `F_GETFL/F_SETFL` + open flags to OS-specific bits (Darwin/Linux differ, Oren source stays portable).
