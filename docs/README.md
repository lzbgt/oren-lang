...
make verify-backend-semantic-diff  # emits C/native/obc parity JSON plus ledger and canonical AVM gas-surface evidence
...
make verify-backend-gas-surface-calibration-set  # combines gas calibration fixtures and sidecar canonical gas evidence
