...
- X64 index/list lowering cleanup now separates map-vs-generic runtime-fast
  ...
  shape, and slot records instead of short-lived keyed maps; LCG sum while,
  lambda literal env, and native allocation kind helpers also use positional
  records.
