...
- Current core includes integer/float abs/min/max/clamp, IEEE-ish predicates and
  ...
  pure finite row-major `std:math/mat4` identity/translation/scale/rotation_x/rotation_y/rotation_z/from_axis_angle/rotation_axis/from_quat/from_quaternion rotation constructors, compose_trs/compose_transform TRS composition, translation_of/scale_of/rotation_quat/decompose_trs/decompose_transform TRS decomposition, ortho/orthographic/frustum/perspective projection, look-at/model_view/view_projection/model-view-projection composition, mul/multiply, transpose/determinant/inverse, normal_matrix3/normal_matrix extraction, transform_point3/transform_point, transform_vec3/transform_vector, transform_normal3/transform_normal, project_point3/project_point, unproject_point3/unproject_point transforms,
