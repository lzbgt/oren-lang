...
- `std:math/mat4` now includes tolerance-aware affine/perspective predicates
  plus exact and tolerance-aware symmetric, diagonal, translation, scale, and
  uniform-scale shape predicates backed by shared row-major matrix validation.
