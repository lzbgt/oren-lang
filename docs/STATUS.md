...
- **Performance parity**: native hot loops remain >2× C (see perf tracker baselines: `loop_sum` 3.39×, `dot_product` 3.98×; `alloc_churn` 5.98×, `alloc_drop` 2.27× on arm64, 2026-02-26).
...
2) **W5 - Performance parity (hot loops + alloc/GC)**
   - Baselines: `loop_sum` 3.39× C, `dot_product` 3.98× C; `alloc_churn` 5.98× C, `alloc_drop` 2.27× C (arm64, 2026-02-26).
...
1) **W5 - Native integer hot-loop parity (loop_sum, dot_product)** (L)
   - Baseline (arm64 native, snapshot 2026-02-26): `loop_sum` 3.39× C, `dot_product` 3.98× C.
