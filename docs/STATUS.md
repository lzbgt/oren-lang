...
- Current core includes integer/float abs/min/max/clamp, IEEE-ish predicates and
  ...
  pure finite `std:math/vec2` length/distance/dot/cross/normalize/angle/rotate plus add/sub/scale/lerp/abs/sign/floor/ceil/round/trunc/fract/saturate/step/smoothstep/smootherstep/inverse_lerp/remap/remap_clamped/min/max/clamp/project/reject/reflect helpers,
  pure finite `std:math/vec3` length/distance/dot/cross/normalize/angle-between plus add/sub/scale/lerp/abs/sign/floor/ceil/round/trunc/fract/saturate/step/smoothstep/smootherstep/inverse_lerp/remap/remap_clamped/min/max/clamp/project/reject/reflect helpers,
  pure finite `std:math/vec4` length/distance/dot/normalize/angle-between plus add/sub/scale/lerp/abs/sign/floor/ceil/round/trunc/fract/saturate/step/smoothstep/smootherstep/inverse_lerp/remap/remap_clamped/min/max/clamp/project/reject/reflect helpers,
