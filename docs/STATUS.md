...
- Current core includes integer/float abs/min/max/clamp, IEEE-ish predicates and
  ...
  pure finite `std:math/vec2` length/distance/dot/cross/normalize/angle/rotate plus add/sub/scale/lerp/midpoint/isclose_abs/isclose/abs/sign/sqrt/cbrt/powi/pow2i/ldexp/scalbn/scalbln/fdim/nextafter/nexttoward/nextup/nextdown/pow/power/hypot/hypot3/erf/erfc/degrees/radians/wrap/wrap_degrees/wrap_radians/angle_delta_degrees/angle_delta_radians/lerp_angle_degrees/lerp_angle_radians/floor/ceil/round/trunc/fract/saturate/step/smoothstep/smootherstep/inverse_lerp/remap/remap_clamped/exp/exp2/exp10/expm1/log/log2/log10/log1p/sin/cos/tan/sin_cos/sinh/cosh/tanh/asinh/acosh/atanh/asin/acos/atan/atan2/min/max/clamp/project/reject/reflect helpers,
  pure finite `std:math/vec3` length/distance/dot/cross/normalize/angle-between plus add/sub/scale/lerp/midpoint/isclose_abs/isclose/abs/sign/sqrt/cbrt/powi/pow2i/ldexp/scalbn/scalbln/fdim/nextafter/nexttoward/nextup/nextdown/pow/power/hypot/hypot3/erf/erfc/degrees/radians/wrap/wrap_degrees/wrap_radians/angle_delta_degrees/angle_delta_radians/lerp_angle_degrees/lerp_angle_radians/floor/ceil/round/trunc/fract/saturate/step/smoothstep/smootherstep/inverse_lerp/remap/remap_clamped/exp/exp2/exp10/expm1/log/log2/log10/log1p/sin/cos/tan/sin_cos/sinh/cosh/tanh/asinh/acosh/atanh/asin/acos/atan/atan2/min/max/clamp/project/reject/reflect helpers,
  pure finite `std:math/vec4` length/distance/dot/normalize/angle-between plus add/sub/scale/lerp/midpoint/isclose_abs/isclose/abs/sign/sqrt/cbrt/powi/pow2i/ldexp/scalbn/scalbln/fdim/nextafter/nexttoward/nextup/nextdown/pow/power/hypot/hypot3/erf/erfc/degrees/radians/wrap/wrap_degrees/wrap_radians/angle_delta_degrees/angle_delta_radians/lerp_angle_degrees/lerp_angle_radians/floor/ceil/round/trunc/fract/saturate/step/smoothstep/smootherstep/inverse_lerp/remap/remap_clamped/exp/exp2/exp10/expm1/log/log2/log10/log1p/sin/cos/tan/sin_cos/sinh/cosh/tanh/asinh/acosh/atanh/asin/acos/atan/atan2/min/max/clamp/project/reject/reflect helpers,
...
- `tests/avm/test_std_math_core.oren`, `tests/avm/test_std_math_pow.oren`,
  ...
  component-wise finite vector `powi`/`pow2i`/`ldexp`/`scalbn`/`scalbln` and `hypot`/`hypot3`, approximate real-valued error functions `erf`/`erfc`, finite sin/cos/sincos/tan reduction, quadrant `atan2`,
