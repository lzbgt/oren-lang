...
dictionaries, removing per-draw model field lookups, and retained material
resources use scalar-key/scalar-value maps instead of boxed `NSNumber` IDs/RGBA
values. Single Metal image texture
