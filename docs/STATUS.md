...
- `tests/avm/test_std_math_core.oren`, `tests/avm/test_std_math_pow.oren`,
  ...
  normal/subnormal/`fpclassify` classification, component-wise ordered comparison predicates plus `signbit`/`copysign`,
