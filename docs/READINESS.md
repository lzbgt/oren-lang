...
- `make verify-status-markdown` — smoke test for the status markdown renderer.
...
- Dashboard supports `--audit-missing-warn-threshold` and `--audit-trend-missing-warn-threshold` for warning banners.
