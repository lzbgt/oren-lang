...
4. **Scientific stdlib math breadth**
   ...
   - Current retained surface includes `fmod`, IEEE-style nearest-even
     ...
     pure finite row-major `std:math/mat4` algebra, transform, normal-matrix, normal transform, model-view-projection composition, orthographic/frustum/perspective projection, screen project/unproject, view helpers, tolerance-aware affine/perspective predicates, and exact/tolerance-aware symmetric/upper-lower-triangular/diagonal/translation/scale/uniform-scale/invertible/singular predicates,
