...
5. **Oren language tooling**
  ...
  - Remaining work is richer member inference beyond direct constructor/alias/factory-expression/constructed-field/call-site/parameter-return/conditional-branch/return-if evidence.
