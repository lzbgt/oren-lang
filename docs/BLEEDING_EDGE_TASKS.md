...
4. **Scientific stdlib math breadth**
   ...
   - Current retained surface includes `fmod`, IEEE-style nearest-even
     ...
     pure finite row-major `std:math/mat4` algebra, transform, orthographic/perspective projection, and view helpers,
...
5. **Oren language tooling**
  ...
  - Remaining work is richer member inference beyond direct constructor/alias/factory/call-site/parameter-return/conditional-branch evidence.
