...
2. **Native performance parity**
   ...
   - Current module-linking prelude parse/import scans, pipeline
     worker/merge/import/table traversals, and tail diagnostic aggregation cache
