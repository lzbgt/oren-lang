...
5. **Oren language tooling**
  ...
  - Current slices add a dependency-free Go JSON-RPC stdio language server with
    ...
    and constructor-bound variable field-chain inference/completion, homogeneous list/hash indexed receiver evidence for field navigation and direct literal completions,
  ...
  - Remaining work is richer member inference beyond direct constructor/alias/factory-expression/constructed-field/constructor-bound-field-chain/call-site/parameter-return/conditional-branch/return-if/indexed-container/list-for-in/scoped-completion evidence.
