...
- `std:math/mat4` determinant, adjugate/cofactor, inverse, condition-number,
  affine-inverse, normal-matrix, point/vector/normal transform, and
  project/unproject implementations now live in focused helper modules while the
  public `mat4` facade keeps stable wrappers below the source-line guardrail.
