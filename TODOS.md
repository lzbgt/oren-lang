...
- `std:math` now includes deterministic tolerance, graphics scalar/interpolation, and range-mapping
  ...
  pure finite `std:math/vec3` helpers for common 3D vector operations including component rounding, interpolation, range-mapping, angle wrapping/interpolation, trig/sin_cos, and inverse-trig helpers, and pure finite
