...
- Native WebSocket binary sends/receives now expose opcode-2 payloads as exact-size validated `u8_buf`, with a >4096-byte masked binary loopback fixture guarding the byte-native path.
