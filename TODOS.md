...
- X64/ARM64 ELF emitters now share `elf_artifact.oren` for common dynamic-link
  ...
  assembly, imported dynsym function entries, ELF64 RELA row packing,
  one-bucket SysV hash tables, PT_INTERP/init-array prelude placement, dynamic
  table blob placement, final dynamic section append/metadata offsets, and
  stable DT_DYNAMIC tags.
