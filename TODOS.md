...
- `std:math` now includes deterministic tolerance, graphics scalar/interpolation, and range-mapping
  ...
  helpers for common 2D graphics/vector operations including component abs/sign/min/max/clamp,
  pure finite `std:math/vec3` helpers for common 3D vector operations including component abs/sign/min/max/clamp, and pure finite
  `std:math/vec4` helpers for homogeneous/vector algebra including component abs/sign/min/max/clamp, backed by native/C/
