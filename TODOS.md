...
- Design and gate an AVM graphics bridge for iOS: Oren emits deterministic 2D/3D command buffers; `libavm` validates capability/budgeted frame and input mailboxes; the host app only implements thin platform adapters for UIKit/Metal and lifecycle. Design note: `project-doc/avm_ios_graphics_design_20260529.md`.
