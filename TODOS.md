...
- Native HTTP/2 client response header-block and unknown-length DATA payload
  ...
  writes stream raw header-block spans across all CONTINUATION frames instead of copied split buffers,
