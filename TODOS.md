...
- LLVM-native now has a `%oren_llvm_map { len, keys, values, key_kinds,
  owner_kind, capacity }` descriptor ABI for empty hash literals,
  ...
  map work is runtime-shaped records and broader runtime-varying descriptor
  inputs.
