...
- LLVM-native now has a `%oren_llvm_map { len, keys, values, key_kinds,
  ...
  execution parity plus forced GC-at-safepoint. Remaining map work is nested map
  descriptor provenance/rooting, runtime-shaped records, and broader
  runtime-varying descriptor inputs.
