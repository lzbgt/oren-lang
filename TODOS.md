...
- Implement an iOS host-adapter SDK (`OrenAVMKit`) so Note can use default policy-controlled FS/NET/PROC/TIME/GFX adapters and compiler-in-AVM helpers instead of hand-writing each bridge. Design note: `project-doc/ios_avm_sdk_design_20260531.md`.
