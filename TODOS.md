...
- Oren LSP member assignment facts now propagate typed dotted member-path writes, including direct struct fields and list/list-of-list container member paths, while unknown member reassignments clear stale completion/navigation evidence.
