...
- Native WebSocket binary sends/receives now expose opcode-2 payloads as validated byte-backed `u8_buf` values, with a >4096-byte masked binary loopback fixture guarding the byte-native path.
