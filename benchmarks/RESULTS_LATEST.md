...
| dot_product | 0.004874 | 0.012928 (2.65×) | 0.024578 (5.04×) | 0.012325 (2.53×) | `benchmarks/results/dot_product_darwin_arm64_20260219_221317.md` |
...
- dot_product (boxed) now ~2.65× C on Oren C and ~5.04× C on native; OBC is ~2.53× after list.push loop opcodes removed the fill-loop overhead (LIST_DOT already handles the inner loop).
