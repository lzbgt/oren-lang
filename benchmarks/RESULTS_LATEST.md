...
| dot_product | 0.004907 | 0.017621 (3.59×) | 0.024677 (5.03×) | 0.586239 (119.47×) | `benchmarks/results/dot_product_darwin_arm64_20260219_091521.md` |
...
- dot_product (boxed) now ~3.6× C on Oren C and ~5.0× C on native; OBC improved to ~119× after LIST_DOT but remains the largest gap.
