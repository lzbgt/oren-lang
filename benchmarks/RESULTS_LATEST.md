...
| dot_product | 0.004889 | 0.017255 (3.53×) | 0.025528 (5.22×) | 0.893932 (182.85×) | `benchmarks/results/dot_product_darwin_arm64_20260219_084719.md` |
...
- dot_product (boxed) now ~3.5× C on Oren C and ~5.2× C on native; OBC remains the largest gap.
