...
expected_hidden_names = {
    "_oren_generator_active_child",
    "_oren_generator_args_list",
    "_oren_generator_bind_active_child",
    "_oren_generator_cached_step",
    ...
    "_oren_generator_done",
    "_oren_generator_done_ch",
    ...
    "_oren_generator_new_context",
    "_oren_generator_new_handle",
    "_oren_generator_push_close_hook",
    "_oren_generator_result_value",
    "_oren_generator_resume",
    "_oren_generator_resume_ch",
    "_oren_generator_restore_active_child",
    "_oren_generator_run_close_hooks",
    "_oren_generator_set",
    "_oren_generator_set_active_child",
    "_oren_generator_set_cached_step",
    "_oren_generator_set_close_hooks",
    "_oren_generator_set_done_flag",
    "_oren_generator_set_result_value",
    "_oren_generator_set_started",
    "_oren_generator_set_task",
    "_oren_generator_set_terminal_err",
    "_oren_generator_step_value",
    "_oren_generator_started",
    "_oren_generator_task",
    "_oren_generator_terminal_err",
    "_oren_generator_terminal_result",
    "_oren_generator_trace",
    "_oren_generator_worker",
    "_oren_generator_yield_ch",
