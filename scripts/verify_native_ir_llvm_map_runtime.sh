...
grep -Fq "declare i64 @oren_llvm_runtime_dynamic_index_get(i64, i64)" "$object.ll"
grep -Fq "declare i64 @oren_llvm_runtime_dynamic_index_get_string(i64, i64)" "$object.ll"
grep -Fq "declare void @oren_llvm_runtime_dynamic_index_set(i64, i64, i64)" "$object.ll"
grep -Fq "declare void @oren_llvm_runtime_dynamic_index_set_string(i64, i64, i64)" "$object.ll"
grep -Fq "declare i32 @memcmp(i8*, i8*, i64)" "$object.ll"
grep -Fq "declare void @oren_llvm_runtime_roots_push_map(i64)" "$object.ll"
grep -Fq "declare void @oren_llvm_runtime_roots_push_value(i64)" "$object.ll"
grep -Fq "call void @oren_llvm_runtime_register_map" "$object.ll"
grep -Fq "call void @oren_llvm_runtime_roots_push_map" "$object.ll"
grep -Fq "call void @oren_llvm_runtime_roots_push_value" "$object.ll"
