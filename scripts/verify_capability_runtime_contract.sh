...
require_literal "$package_policy_runner" "--gas-profile native-stmt|avm-sidecar|auto"
require_literal "$package_policy_runner" "dispatcher default"
require_literal "$package_policy_runner" 'OREN_NATIVE_PACKAGE_POLICY_GAS_PROFILE="auto"'
require_literal "$package_policy_runner" "--gas-profile applies only to --backend native"
...
require_literal "$native_policy_runner" "oren.avm-canonical-sidecar-gas.v0"
...
require_literal "$native_policy_runner" "native_stdout_sha256"
require_literal "$native_policy_runner" "sidecar_stdout_sha256"
require_literal "$native_policy_runner" "source_sha256"
require_literal "$native_policy_runner" "native_artifact_sha256"
require_literal "$native_policy_runner" "sidecar_artifact_sha256"
require_literal "$native_policy_runner" "program_args_sha256"
require_literal "$native_policy_runner" "package_policy_sha256"
require_literal "$native_policy_runner" "package_policy_declared"
require_literal "$native_policy_runner" "sidecar_run_json_present"
require_literal "$native_policy_runner" "sidecar_run_json_schema"
require_literal "$native_policy_runner" "sidecar_run_json_status"
require_literal "$native_policy_runner" "sidecar_run_json_error"
...
require_literal "$native_policy_runner" "not AVM-canonical opcode gas"
...
require_literal "$native_policy_runner_guard" "native_package_policy_runner_gas_native_fail.oren"
...
require_literal "$native_policy_runner_guard" "native_statement_or_op"
require_literal "$native_policy_runner_guard" "AVM canonical"
...
require_literal "$native_policy_runner_guard" "program_args_sha256"
require_literal "$native_policy_runner_guard" "package_policy_sha256"
require_literal "$native_policy_runner_guard" "package_policy_declared"
require_literal "$native_policy_runner_guard" "sidecar_run_json_present"
require_literal "$native_policy_runner_guard" "sidecar_run_json_schema"
require_literal "$native_policy_runner_guard" "sidecar_run_json_status"
require_literal "$native_policy_runner_guard" "sidecar_run_json_error"
...
require_literal "$native_policy_runner_guard" "OREN_NATIVE_PACKAGE_POLICY_TEST_AVM_SIDECAR_DROP_GAS_SURFACE"
require_literal "$native_policy_runner_guard" "OREN_NATIVE_PACKAGE_POLICY_TEST_AVM_SIDECAR_SCHEMA"
require_literal "$native_policy_runner_guard" "OREN_NATIVE_PACKAGE_POLICY_TEST_AVM_SIDECAR_ZERO_GAS"
require_literal "$native_policy_runner_guard" "OREN_NATIVE_PACKAGE_POLICY_TEST_AVM_SIDECAR_TIMEOUT"
require_literal "$native_policy_runner_guard" "OREN_NATIVE_PACKAGE_POLICY_TEST_AVM_SIDECAR_BUILD_FAIL"
require_literal "$native_policy_runner_guard" "OREN_NATIVE_PACKAGE_POLICY_TEST_AVM_SIDECAR_RUN_ERROR"
...
require_literal "$native_policy_runner_guard" "stderr_suffix+schema"
require_literal "$native_policy_runner_guard" "exit_code"
require_literal "$native_policy_runner_guard" "drop_gas_surface"
require_literal "$native_policy_runner_guard" "drop_run_json"
require_literal "$native_policy_runner_guard" "schema"
require_literal "$native_policy_runner_guard" "zero_gas"
require_literal "$native_policy_runner_guard" "timeout"
require_literal "$native_policy_runner_guard" "build_fail"
require_literal "$native_policy_runner_guard" "run_error"
require_literal "$native_policy_runner_guard" "not_run_native_failed"
...
require_literal "$native_policy_runner_guard" "missing_or_noncanonical_avm_gas_surface"
require_literal "$native_policy_runner_guard" "missing_or_noncanonical_avm_run_json"
require_literal "$native_policy_runner_guard" "missing_or_nonpositive_avm_gas"
require_literal "$native_policy_runner_guard" "sidecar_build_failed"
require_literal "$native_policy_runner_guard" "native_exit_nonzero"
require_literal "$native_policy_runner_guard" "native_run_failed_before_sidecar"
require_literal "$native_policy_runner_guard" "package AVM canonical sidecar gas could not be certified for native run"
require_literal "$native_policy_runner_guard" "schema-mismatched stderr-budget AVM sidecar"
require_literal "$native_policy_runner_guard" "must not take the budget-exceeded path"
require_literal "$native_policy_runner_guard" "package AVM canonical sidecar timed out"
require_literal "$native_policy_runner_guard" "package AVM canonical sidecar build failed"
...
require_literal "$native_policy_runner_guard" "verifier non-gas sidecar error"
...
require_literal Makefile "verify-yield-backend-parity-v0: oren_stage2 avm"
require_literal Makefile "verify-yield-value-surface-v0: oren_stage2 avm"
require_literal Makefile "verify-yield-exchange-surface-v0: oren_stage2 avm"
require_literal Makefile "verify-generator-surface-v0: oren_stage2 avm"
require_literal Makefile "verify-coroutine-surface-v0: oren_stage2 avm"
require_literal Makefile "verify-task-surface-v0: oren_stage2 avm"
require_literal Makefile "verify-task-group-surface-v0: oren_stage2 avm"
require_literal Makefile "verify-task-group-task-surface-v0: oren_stage2 avm"
require_literal Makefile "verify-generator-import-yield-regression: oren_stage2"
require_literal Makefile "verify-generator-nested-green-resume-v0: oren_stage2"
require_literal Makefile "verify-native-quick-stage2-direct-autoseed: oren oren_stage2"
...
require_literal Makefile "./scripts/verify_yield_metadata.sh"
require_literal Makefile "./scripts/verify_yield_lowering_v0.sh"
require_literal Makefile "./scripts/verify_yield_backend_parity_v0.sh"
require_literal Makefile "./scripts/verify_yield_value_surface_v0.sh"
require_literal Makefile "./scripts/verify_yield_exchange_surface_v0.sh"
require_literal Makefile "./scripts/verify_generator_surface_v0.sh"
require_literal Makefile "./scripts/verify_coroutine_surface_v0.sh"
require_literal Makefile "./scripts/verify_task_surface_v0.sh"
require_literal Makefile "./scripts/verify_task_group_surface_v0.sh"
require_literal Makefile "./scripts/probe_generator_import_yield_regression.sh"
require_literal Makefile "./scripts/verify_generator_nested_green_resume_v0.sh"
require_literal Makefile "./scripts/verify_native_quick_stage2_direct_autoseed.sh"
