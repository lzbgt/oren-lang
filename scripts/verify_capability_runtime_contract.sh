...
require_literal Makefile "probe-generator-nested-green-resume-block-v0: oren_stage2"
...
require_literal Makefile "./scripts/probe_generator_nested_green_resume_block_v0.sh"
