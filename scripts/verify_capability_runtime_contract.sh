...
require_literal "$package_policy_runner" "--gas-profile native-stmt|avm-sidecar"
...
require_literal "$native_policy_runner_guard" "must be native-stmt or avm-sidecar"
