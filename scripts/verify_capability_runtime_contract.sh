...
require_literal Makefile "test: verify-capability-runtime-contract verify-capability-metadata verify-yield-metadata verify-yield-lowering-v0 verify-yield-backend-parity-v0 verify-yield-value-surface-v0 verify-yield-exchange-surface-v0 verify-generator-surface-v0 verify-coroutine-surface-v0 verify-task-group-surface-v0 verify-generator-finalize-surface-v0 verify-generator-import-yield-regression verify-generator-nested-green-resume-v0 verify-capability-manifest-policy verify-effect-ledger-contract verify-avm-package-policy-runner verify-native-package-policy-runner verify-native-capsule-resource-checks verify-native-gas-accounting-modes verify-gas-surface-registry verify-public-readme-positioning verify-avm-spawn-channel-args verify-oretest verify-native-quick-stage2-direct-autoseed test-native-quick"
