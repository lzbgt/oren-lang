...
end="$(date +%s)"
{
  ...
  printf 'coverage=host-arm64-macos,native-oracle,llvm-link,llvm-execute,named-oren-string-eq-helper,string-descriptor-equality,string-descriptor-inequality,static-owner-metadata\n'
} >"$summary"
