...
metric_re = re.compile(
    r"^(exit_status|failed_step|steady_array_sum|steady_dot_product|gate_array_sum|gate_dot_product|"
    r"disasm_array_sum_insns|disasm_dot_product_insns|debug_status|debug_exit_code): (.+)$"
)
