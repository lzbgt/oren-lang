...
avm_canonical_sidecar_gas = {
    ...
    "sidecar_run_json_present": isinstance(obc_run_json, dict),
    "sidecar_run_json_schema": obc_run_json_schema,
    "sidecar_run_json_status": obc_run_json.get("status") if isinstance(obc_run_json, dict) else None,
    "sidecar_run_json_error": obc_run_json.get("error") if isinstance(obc_run_json, dict) else None,
    "same_source": True,
