...
files = {
    ...
    "avm_effect_ledger": Path("lib/avm/avm_main_effect_ledger.inc"),
...
surfaces = [
    {
        ...
        "avm_canonical": True,
        "required_files": ["registry", "effect_contract", "avm_effect_ledger", "avm_guard", "semantic_guard", "calibration_guard", "instruction_guard"],
...
global_literals = [
    ...
    ("native_policy_guard", "stderr_suffix+schema"),
    ...
    ("native_policy_guard", "schema-mismatched stderr-budget AVM sidecar"),
    ("native_policy_guard", "must not take the budget-exceeded path"),
    ...
    ("avm_effect_ledger", "unit_scope"),
    ("avm_effect_ledger", "avm_canonical"),
