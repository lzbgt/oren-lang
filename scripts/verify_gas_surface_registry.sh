...
global_literals = [
    ...
    ("semantic_runner", "source_sha256"),
    ("semantic_runner", "native_artifact_sha256"),
    ("semantic_runner", "sidecar_artifact_sha256"),
    ("semantic_runner", "program_args_sha256"),
    ("semantic_runner", "package_policy_sha256"),
    ("semantic_runner", "package_policy_declared"),
    ("semantic_runner", "sidecar_run_json_present"),
    ("semantic_runner", "sidecar_run_json_schema"),
    ("semantic_runner", "sidecar_run_json_status"),
    ("semantic_runner", "sidecar_run_json_error"),
    ...
    ("calibration_guard", "avm_canonical_sidecar_identity_hashes_present_all"),
    ("calibration_guard", "avm_canonical_sidecar_input_binding_present_all"),
    ("calibration_guard", "avm_canonical_sidecar_run_json_ok_all"),
    ("calibration_guard", "avm_canonical_sidecar_run_json_status"),
    ("calibration_guard", "avm_canonical_sidecar_run_json_error"),
    ("calibration_guard", "avm_canonical_sidecar_program_args_sha256"),
    ("calibration_guard", "avm_canonical_sidecar_package_policy_sha256"),
    ("calibration_guard", "avm_canonical_sidecar_source_sha256"),
    ("calibration_guard", "avm_canonical_sidecar_native_artifact_sha256"),
    ("calibration_guard", "avm_canonical_sidecar_sidecar_artifact_sha256"),
    ...
    ("instruction_guard", "avm_canonical_sidecar_identity_hashes_present_all"),
    ("instruction_guard", "avm_canonical_sidecar_input_binding_present_all"),
    ("instruction_guard", "avm_canonical_sidecar_run_json_ok_all"),
    ("instruction_guard", "avm_canonical_sidecar_run_json_status"),
    ("instruction_guard", "avm_canonical_sidecar_run_json_error"),
    ("instruction_guard", "avm_canonical_sidecar_program_args_sha256"),
    ("instruction_guard", "avm_canonical_sidecar_package_policy_sha256"),
    ("instruction_guard", "avm_canonical_sidecar_source_sha256"),
    ("instruction_guard", "avm_canonical_sidecar_native_artifact_sha256"),
    ("instruction_guard", "avm_canonical_sidecar_sidecar_artifact_sha256"),
    ...
    ("native_policy_runner", "source_sha256"),
    ("native_policy_runner", "native_artifact_sha256"),
    ("native_policy_runner", "sidecar_artifact_sha256"),
    ("native_policy_runner", "program_args_sha256"),
    ("native_policy_runner", "package_policy_sha256"),
    ("native_policy_runner", "package_policy_declared"),
    ("native_policy_runner", "sidecar_run_json_present"),
    ("native_policy_runner", "sidecar_run_json_schema"),
    ("native_policy_runner", "sidecar_run_json_status"),
    ("native_policy_runner", "sidecar_run_json_error"),
    ...
    ("native_policy_guard", "program_args_sha256"),
    ("native_policy_guard", "package_policy_sha256"),
    ("native_policy_guard", "package_policy_declared"),
    ("native_policy_guard", "sidecar_run_json_present"),
    ("native_policy_guard", "sidecar_run_json_schema"),
    ("native_policy_guard", "sidecar_run_json_status"),
    ("native_policy_guard", "sidecar_run_json_error"),
    ...
    ("native_policy_guard", "OREN_NATIVE_PACKAGE_POLICY_TEST_AVM_SIDECAR_SCHEMA"),
    ...
    ("native_policy_guard", "OREN_NATIVE_PACKAGE_POLICY_TEST_AVM_SIDECAR_RUN_ERROR"),
    ...
    ("native_policy_guard", "schema"),
    ("native_policy_guard", "zero_gas"),
    ("native_policy_guard", "timeout"),
    ("native_policy_guard", "build_fail"),
    ("native_policy_guard", "run_error"),
    ("native_policy_guard", "not_run_native_failed"),
    ...
    ("native_policy_guard", "missing_or_noncanonical_avm_run_json"),
    ("native_policy_guard", "missing_or_nonpositive_avm_gas"),
    ("native_policy_guard", "sidecar_build_failed"),
    ("native_policy_guard", "native_exit_nonzero"),
    ("native_policy_guard", "native_run_failed_before_sidecar"),
    ...
    ("native_policy_guard", "verifier non-gas sidecar error"),
    ("avm_main", "unit_scope"),
