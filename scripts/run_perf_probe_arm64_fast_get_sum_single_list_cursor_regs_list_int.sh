...
summary_log="$log_dir/perf-probe-arm64-fast-get-sum-single-list-cursor-regs-list-int-${ts}.log"
default_log="$log_dir/perf-probe-arm64-fast-get-sum-single-list-cursor-regs-list-int-default-${ts}.run.log"
disabled_log="$log_dir/perf-probe-arm64-fast-get-sum-single-list-cursor-regs-list-int-disabled-${ts}.run.log"

programs="${OREN_ARM64_FAST_GET_SUM_CURSOR_REGS_LIST_INT_PROGRAMS:-array_sum_int}"
run_test="${OREN_ARM64_FAST_GET_SUM_CURSOR_REGS_LIST_INT_RUN_TEST:-0}"
disable_env="${OREN_ARM64_FAST_GET_SUM_CURSOR_REGS_LIST_INT_DISABLE_ENV:-OREN_ARM64_FAST_LIST_INT_GET_SUM_SINGLE_LIST_CURSOR_REGS=0}"
...
print("arm64 fast get-sum single-list cursor-reg list<int> probe summary")
print("")
...
echo "arm64 fast get-sum single-list cursor-reg list<int> probe complete; summary: $summary_log"
