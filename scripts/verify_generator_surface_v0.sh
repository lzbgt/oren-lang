...
for payload, detail_key in [(meta, False), (dump, True), (obc, False)]:
    assert_decl(
        ...
        count=2,
        sites=[
            "tests/fixtures/generator_surface_v0.oren:35:20",
            "tests/fixtures/generator_surface_v0.oren:36:20",
        ],
        context="var_init",
        explicit_value=True,
    )
    assert_decl(
        ...
        count=1,
        sites=["tests/fixtures/generator_surface_v0.oren:42:5"],
        context="expr_stmt",
    ...
    assert_decl(
        ...
        count=1,
        sites=["tests/fixtures/generator_surface_v0.oren:50:9"],
        context="expr_stmt",
        explicit_value=True,
    )
    assert_decl(
