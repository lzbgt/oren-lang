...
for payload, detail_key in [(meta, False), (dump, True), (obc, False)]:
    assert_decl(
        ...
        count=2,
        sites=[
            "tests/fixtures/generator_surface_v0.oren:75:20",
            "tests/fixtures/generator_surface_v0.oren:76:20",
        ],
        context="var_init",
        explicit_value=True,
    )
    assert_decl(
        ...
        count=1,
        sites=["tests/fixtures/generator_surface_v0.oren:82:5"],
        context="expr_stmt",
    ...
    assert_decl(
        ...
        count=1,
        sites=["tests/fixtures/generator_surface_v0.oren:90:9"],
        context="expr_stmt",
        explicit_value=True,
    )
    assert_decl(
        ...
        sites=[
            ...
            "tests/fixtures/generator_surface_v0.oren:99:20",
        ],
        context="var_init",
        explicit_value=True,
    )
    assert_decl(
        ...
        count=1,
        sites=["tests/fixtures/generator_surface_v0.oren:105:19"],
        context="var_init",
        explicit_value=True,
    )
