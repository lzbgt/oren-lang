...
require_literal "$semantic_diff_runner" "OREN_NATIVE_GAS_ACCOUNTING=stmt"
require_literal "$semantic_diff_runner" "native statement+loop gas surface"
...
require_literal "$semantic_diff_guard" "native_stmt_loop_tick_v0"
