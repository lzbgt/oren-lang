...
require_literal "$semantic_diff_runner" "OREN_NATIVE_GAS_ACCOUNTING=block-weighted"
require_literal "$semantic_diff_runner" "native weighted lowering-block gas surface"
...
require_literal "$semantic_diff_guard" "native_block_weighted_tick_v0"
...
require_literal "$gas_calibration_set_guard" "native_instruction_equivalent_gas"
