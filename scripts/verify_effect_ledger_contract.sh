...
require_literal "$native_policy_runner" "cannot enforce budget_gas"
...
require_literal "$native_policy_runner_guard" "native_package_policy_runner_unsupported_gas.oren"
...
require_literal "$native_policy_runner_guard" "cannot enforce budget_gas"
