...
require_literal "$semantic_diff_runner" "OREN_NATIVE_GAS_ACCOUNTING=basic-block"
require_literal "$semantic_diff_runner" "native lowering-block gas surface"
...
require_literal "$semantic_diff_guard" "native_basic_block_tick_v0"
...
require_literal "$gas_calibration_set_guard" "native_instruction_equivalent_or_block_weighted_gas"
