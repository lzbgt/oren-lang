...
require_literal "$gas_calibration_set_guard" "validated_native_dynamic_emitter_or_instruction_equivalent_gas"
...
require_literal "$native_instruction_surface_guard" "validated_native_dynamic_emitter_or_instruction_equivalent_gas"
