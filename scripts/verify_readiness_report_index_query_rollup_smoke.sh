...
query_faq_exists_out="${work_dir}/query_faq_exists.jsonl"
query_overview_out="${work_dir}/query_overview.jsonl"
query_overview_exists_out="${work_dir}/query_overview_exists.jsonl"
rollup_md="${work_dir}/rollup.md"
rollup_json="${work_dir}/rollup.json"

rm -rf "$work_dir" 2>/dev/null || true
mkdir -p "$work_dir"
: > "${work_dir}/status_faq_20260305_010000.md"
: > "${work_dir}/status_overview_20260305_010000.md"

cat >"$index_path" <<EOF
{"timestamp":"20260305_010000","profile":"quick","overall":"PASS","dry_run":false,"total_duration_sec":42,"git_rev":"abcd1234","git_dirty":"clean","report":"build/reports/readiness_report_20260305_010000.md","json":"build/reports/readiness_report_20260305_010000.json","log_dir":"build/logs/readiness_20260305_010000","status_faq_md":"${work_dir}/status_faq_20260305_010000.md","status_overview_md":"${work_dir}/status_overview_20260305_010000.md","tag":"nightly"}
...
./scripts/readiness_report_index_query.py --index "$index_path" --require-file status_faq_md --out "$query_faq_exists_out"
./scripts/readiness_report_index_query.py --index "$index_path" --require-field status_overview_md --out "$query_overview_out"
./scripts/readiness_report_index_query.py --index "$index_path" --require-file status_overview_md --out "$query_overview_exists_out"
...
rg -n "20260305_010000" "$query_faq_exists_out" >/dev/null
! rg -n "20260306_090000" "$query_faq_exists_out" >/dev/null
rg -n "20260305_010000" "$query_overview_out" >/dev/null
! rg -n "20260306_090000" "$query_overview_out" >/dev/null
